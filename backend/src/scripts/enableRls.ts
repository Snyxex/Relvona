...
const tenantTables = [
  "knowledge_ingestion_jobs", "api_keys", "customers", "assistants", "assistant_versions", "knowledge_bases", "knowledge_sources", "document_chunks", "websites", "website_pages", "conversations", "conversation_messages", "message_feedback", "tickets", "ticket_comments", "analytics_events", "audit_logs", "organization_settings", "model_routing_rules", "conversation_activities", "conversation_handoffs", "conversation_tags", "conversation_tag_links", "agent_presence", "employee_directory", "mail_server_settings", "anonymous_visitors", "visitor_conversations", "visitor_memories", "customer_portal_accounts", "customer_portal_magic_links", "customer_portal_sessions", "customer_portal_visitor_links", "ticket_sla_policies", "ticket_case_metadata", "ticket_case_events", "calendar_connections", "meeting_types", "availability_rules", "bookings", "booking_events", "booking_calendar_sync", "action_executions", "calendar_oauth_states", "conversation_scheduling_states", "knowledge_gaps", "knowledge_gap_signals", "knowledge_source_intelligence", "knowledge_retrieval_events", "knowledge_faq_drafts", "knowledge_collections", "source_knowledge_collections", "assistant_knowledge_collections", "webhook_subscriptions", "webhook_events", "webhook_deliveries", "integration_connections", "integration_sync_rules", "integration_sync_executions", "integration_inbound_events", "external_actors", "external_ticket_messages", "notification_settings", "notifications",
];
