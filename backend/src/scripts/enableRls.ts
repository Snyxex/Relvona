...
const tenantTables = [
  "knowledge_ingestion_jobs", "api_keys", "customers", "assistants", "knowledge_bases", "knowledge_sources", "document_chunks", "websites", "website_pages", "conversations", "conversation_messages", "message_feedback", "tickets", "ticket_comments", "analytics_events", "audit_logs", "organization_settings", "model_routing_rules", "conversation_activities", "conversation_handoffs", "conversation_tags", "conversation_tag_links", "agent_presence", "anonymous_visitors", "visitor_conversations", "visitor_memories",
];
