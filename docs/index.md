# Relvona Documentation

Welcome to the Relvona documentation. This documentation is written for administrators, support teams, operators, and developers.

## Start here

- [Product overview](features.md) — what Relvona can do and how the main features work.
...
Read [Technology stack](technologie-stack.md), [`CONTRIBUTING.md`](../CONTRIBUTING.md), the repository source, and the API routes under `backend/src/routes/`.

## Core concepts

Relvona is multi-tenant. Each organization has its own users, assistants, knowledge, conversations, customers, tickets, integrations, settings, and analytics. Tenant-owned data is isolated at the application layer and additionally protected by PostgreSQL row-level security where configured.
...
A **knowledge base** contains information used for retrieval-augmented generation (RAG). Content can come from FAQs, text, documents, PDFs, and approved public websites.
