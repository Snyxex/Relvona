...
export default function AdminIntegrationsPage() {
  ...
  async function remove(subscription: Subscription) {
    ...
    try { await api.delete(`/webhooks/${subscription.id}`); await load(); }
