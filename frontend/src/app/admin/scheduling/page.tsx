...
export default function AdminSchedulingPage() {
  ...
  return <main className="mx-auto max-w-6xl space-y-6 p-4 sm:p-8">
    ...
    <DeferredRender minHeight={220}><AvailabilityEditor meetingTypes={types} readOnly={!canManageConfiguration} /></DeferredRender>
    <DeferredRender minHeight={420}><BookingManager onError={setError} /></DeferredRender>
    {capabilities?.canViewAudit && <DeferredRender minHeight={220}><SchedulingAuditTrail /></DeferredRender>}
  </main>;
}
